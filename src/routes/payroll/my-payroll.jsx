...
const PayrollPage = () => {
    ...
    const fetchPayrolls = async () => {
        ...
        try {
            const response = await api.get('/pr/payroll/me');
        ...
        if (searchTerm.trim() === "") {
            ...
            const filtered = payrolls.filter((payroll) => {
                return (
                    ...
                    (payroll.SalaryMonth && formatDate(payroll.SalaryMonth).toLowerCase().includes(lowercasedTerm))
                );
            });
    ...
    return (
        <div className="flex flex-col gap-y-4">
            <div className="flex justify-between items-center">
                <h1 className="title">Bảng lương cá nhân</h1>
            </div>
            ...
            <div className="card ">
                <div className="p-4 border-b border-gray-200 flex justify-between items-center">
                    <div className="flex gap-2 items-center">
                        <ExportDropdown data={filteredPayrolls} filename="my_payroll_list" />
                    </div>
                    <div className="flex gap-2 items-center">
                        ...
                        <SearchInput
                            ...
                            placeholder="Tìm kiếm theo tháng lương, phòng ban..."
